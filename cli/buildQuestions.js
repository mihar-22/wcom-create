...
module.exports = (targetDir, guessedAuthorInfo) => [
  {
    ...
    validate(input) {
      ...
      if (input[input.length - 1] === "-")
        return "The name cannot end in a dash (-).";
      return true;
    },
  },
  {
  ...
  },
  {
    ...
    name: "keywords",
    message:
      "A few keywords that will help people discover your package (comma separated):",
    separator: ",",
  },
  {
    type: "select",
    name: "license",
    message:
      "Pick a license (see https://choosealicense.com for more information):",
    choices: [
      { title: "MIT", value: "MIT" },
  ...
  },
  {
    ...
    name: "githubRepo",
    message:
      "The name of the GitHub repository where this project is stored (eg: wcom/cli)?",
    format(input) {
      input = input.startsWith("https://")
